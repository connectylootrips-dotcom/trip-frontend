...
<div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;">
  <div style="background:#111827;padding:24px 28px;">
    ...
    <div style="font-size:20px;font-weight:700;color:#fff;">${esc(role)}</div>
  </div>
  <div style="padding:24px 28px;">
    <table style="width:100%;border-collapse:collapse;font-size:14px;">
      <tr><td style="padding:6px 0;color:#6b7280;width:120px;">Name</td><td style="padding:6px 0;font-weight:600;color:#111827;">${esc(name)}</td></tr>
      <tr><td style="padding:6px 0;color:#6b7280;">Email</td><td style="padding:6px 0;"><a href="mailto:${esc(email)}" style="color:#6366f1;">${esc(email)}</a></td></tr>
      ${phone ? `<tr><td style="padding:6px 0;color:#6b7280;">Phone</td><td style="padding:6px 0;color:#111827;">${esc(phone)}</td></tr>` : ''}
      ${experience ? `<tr><td style="padding:6px 0;color:#6b7280;">Experience</td><td style="padding:6px 0;color:#111827;">${esc(experience)}</td></tr>` : ''}
    </table>
    <div style="margin-top:16px;padding:14px;background:#f9fafb;border-radius:8px;border-left:3px solid #6366f1;">
      ...
      <div style="font-size:14px;color:#374151;line-height:1.6;">${esc(message).replace(/\n/g, '<br>')}</div>
    </div>
