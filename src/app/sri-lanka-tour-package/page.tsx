...
export default async function SriLankaPackagePage() {
  ...
  const pkg: PackageData = {
    ...
    mustVisitPlaces: [
      { name: 'Sigiriya Rock Fortress', description: 'A 200m vertical granite monolith with the ruins of a 5th-century royal palace on top. The famous mirror wall with ancient graffiti and the celestial fresco gallery of 21 "cloud maidens" are on the ascent.', image: 'https://images.unsplash.com/photo-1580182970834-f6b84e0a218c?w=800&q=80', type: 'landmark', tip: 'Climb before 8am — it\'s cooler, less crowded, and the morning light on the surrounding jungle is spectacular. The climb takes 40 minutes up.' },
      { name: 'Ella — Nine Arch Bridge', description: 'A colonial-era stone railway viaduct in Ella\'s green hills — one of Sri Lanka\'s most photographed landmarks. The Kandy–Ella train ride itself is one of Asia\'s most scenic railway journeys.', image: 'https://images.unsplash.com/photo-1566296314736-6eaac1ca0cb9?w=800&q=80', type: 'landmark', tip: 'Time the Nine Arch Bridge at the train schedule (10:45am and 6pm are the best departures). The viewpoint is a 15-minute walk from Ella town.' },
      { name: 'Galle Fort', description: 'A 17th-century Dutch colonial fort-city on Sri Lanka\'s south coast — UNESCO World Heritage. Pastel colonial buildings, rampart walls overlooking the Indian Ocean, boutique cafes, and independent jewellery shops.', image: 'https://images.unsplash.com/photo-1560185007-c5ca9d2c014d?w=800&q=80', type: 'culture', tip: 'Walk the full 1.3km rampart circuit at sunset. The lighthouse end gives the best views. The fort has some of Sri Lanka\'s finest restaurants inside the colonial walls.' },
    ],
    packageActivities: [
      { name: 'Kandy–Ella Scenic Train Ride', description: 'A 7-hour train journey through tea country — arguably the most beautiful railway ride in Asia. Misty hills, waterfall gorges, and colonial-era tunnels from the 1800s.', image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=800&q=80', duration: '7 hours', cost: '₹800–2,500 first class' },
      { name: 'Whale Watching — Mirissa', description: 'Blue whale and sperm whale watching from Mirissa beach (November–April) — Sri Lanka has one of the world\'s highest blue whale sighting rates. Dolphins often ride the bow wave.', image: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=800&q=80', duration: '4–6 hours', cost: '₹2,000–3,000' },
    ],
    travelTips: [
