...
export default async function EuropePackagePage() {
  ...
  const pkg: PackageData = {
    ...
    packageActivities: [
      { name: 'Amsterdam Canal Boat Tour', description: 'A 1-hour glass-boat canal cruise through Amsterdam\'s UNESCO-listed canal ring — 165 canals, 1,281 bridges, and 17th-century merchant townhouses reflected in the still water.', image: 'https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=800&q=80', duration: '1 hour', cost: 'Included in package' },
      { name: 'Prague Old Town Walking Tour', description: 'Walk through Central Europe\'s best-preserved medieval city — the astronomical clock, Charles Bridge at dawn, and the labyrinthine Old Town lanes untouched since the 14th century.', image: 'https://images.unsplash.com/photo-1541849546-216549ae216d?w=800&q=80', duration: '3 hours', cost: 'Included in package' },
    ],
    travelTips: [
