...
export default async function JapanPackagePage() {
  ...
  const pkg: PackageData = {
    ...
    mustVisitPlaces: [
      { name: 'Fushimi Inari Shrine — Kyoto', description: '10,000 vermilion torii gates winding up the forested Mount Inari behind Kyoto. The famous tunnel of gates stretches 4km to the summit — most people only walk the first 30 minutes, missing the empty upper trails.', image: 'https://images.unsplash.com/photo-1478436127897-769e1b3f0f36?w=800&q=80', type: 'landmark', tip: 'Arrive at 6am — the lower gates are already crowded by 8am. Hike to the top (90 minutes) for the empty upper trails and city views.' },
      { name: 'Mt. Fuji — Hakone Viewpoint', description: 'Japan\'s iconic 3,776m perfectly-shaped volcanic cone — visible on clear days from Hakone\'s Owakudani valley, Lake Kawaguchi, and the Shinkansen. December–February gives the best visibility.', image: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?w=800&q=80', type: 'nature', tip: 'Check the Fuji visibility forecast (fujisan.ne.jp) the night before — cloud cover hides the summit 60% of the time. Lake Kawaguchiko at dawn is the most iconic viewpoint.' },
      { name: 'Shinjuku & Harajuku — Tokyo', description: 'Shinjuku\'s neon-lit nightlife streets, the incredible Shinjuku Gyoen garden, and Harajuku\'s Takeshita Street for Japan\'s famous youth fashion subcultures. The Meiji Shrine is 2 minutes from Harajuku station.', image: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=800&q=80', type: 'culture', tip: 'Tokyo\'s convenience stores (7-Eleven, FamilyMart) have exceptional food — onigiri, katsu sandwiches, hot ramen. Some of Japan\'s best quick meals cost ₹100–200.' },
    ],
    packageActivities: [
      { name: 'Tsukiji Outer Market Breakfast — Tokyo', description: 'The world\'s most famous fish market outer section — still operating daily. Ultra-fresh tuna sashimi, sea urchin, and tamagoyaki (egg rolls) for breakfast from stalls that open at 5am.', image: 'https://images.unsplash.com/photo-1569050467447-ce54b3bbc37d?w=800&q=80', duration: '2 hours', cost: '₹800–1,500 food' },
      { name: 'Arashiyama Bamboo Grove — Kyoto', description: 'Walk through a towering grove of bamboo stalks that filter sunlight into an otherworldly green haze. Adjacent: the Tenryu-ji Zen garden (UNESCO) and the Okochi Sanso villa garden.', image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800&q=80', duration: '3–4 hours', cost: '₹500 Tenryu-ji entry' },
    ],
    travelTips: [
