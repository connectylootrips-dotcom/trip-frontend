...
export default async function NepalPackagePage() {
  ...
  const pkg: PackageData = {
    ...
    mustVisitPlaces: [
      { name: 'Pashupatinath Temple', description: 'Nepal\'s holiest Hindu temple on the Bagmati River — ghats, cremation pyres, sadhus, and a 17th-century golden pagoda. One of South Asia\'s most spiritually intense experiences.', image: 'https://images.unsplash.com/photo-1585960573067-7e0be89f7b6a?w=800&q=80', type: 'landmark', tip: 'Visit at 6am for morning aarti. Non-Hindus enter the outer temple area — the ghats viewpoint across the river is fully accessible and equally powerful.' },
      ...
      { name: 'Pokhara & Phewa Lake', description: 'Nepal\'s lakeside city with the Annapurna massif reflecting in Phewa Lake. The World Peace Pagoda at dawn gives panoramic views of Annapurna, Dhaulagiri, and Machapuchare.', image: 'https://images.unsplash.com/photo-1526772662000-3f88f10405ff?w=800&q=80', type: 'nature', tip: 'Take a sunrise cable car to the Peace Pagoda for Annapurna views — on clear days (Oct–Nov, Mar–Apr) this is one of the Himalayan world\'s finest panoramas.' },
    ],
    packageActivities: [
      { name: 'Everest Base Camp Mountain Flight', description: 'A 1-hour flight from Kathmandu along the Himalayan range — window seat views of Everest, Lhotse, Makalu, and the Khumbu Icefall. The closest most visitors get to the world\'s highest mountain.', image: 'https://images.unsplash.com/photo-1571401835393-8c5f35328320?w=800&q=80', duration: '1 hour', cost: '₹7,000–10,000' },
      { name: 'Chitwan Jungle Safari', description: 'Jeep and elephant-back safaris through Chitwan National Park — one of Asia\'s finest wildlife reserves. One-horned rhino, Bengal tiger (rare), sloth bear, and gharial crocodile.', image: 'https://images.unsplash.com/photo-1504893524553-b855bce32c67?w=800&q=80', duration: 'Full day', cost: 'Included in extended package' },
    ],
    travelTips: [
