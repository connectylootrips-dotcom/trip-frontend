...
export default async function AndamanPackagePage() {
  ...
  const pkg: PackageData = {
    ...
    mustVisitPlaces: [
      ...
      { name: 'Cellular Jail — Port Blair', description: 'The former British colonial prison where freedom fighters were exiled. The 698-cell radial jail is now a national memorial. The nightly Sound and Light show is one of India\'s most moving heritage experiences.', image: 'https://images.unsplash.com/photo-1509233725247-49e657c54213?w=800&q=80', type: 'landmark', tip: 'Book the 7:15pm Sound & Light show in advance — it sells out. The performance is in Hindi and English alternately (check which night you visit).' },
      { name: 'Neil Island — Natural Bridge & Bharatpur Beach', description: 'A smaller, quieter island with a stunning natural coral bridge at Laxmanpur Beach and the clearest water at Bharatpur. Cycling the whole island takes 2 hours.', image: 'https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?w=800&q=80', type: 'nature', tip: 'Rent a bicycle on Neil Island (₹150/day) — the island is small, traffic-free, and the coral bridge viewpoint is not accessible by vehicle.' },
    ],
    packageActivities: [
      { name: 'Scuba Diving — Havelock', description: 'Discover scuba at Elephant Beach or Nemo Reef — no experience needed. Crystal visibility, coral gardens, and tropical fish in warm 28°C water. Certified divers can explore wrecks and deeper reefs.', image: 'https://images.unsplash.com/photo-1582967788606-a171c1080cb0?w=800&q=80', duration: '2 hours with briefing', cost: '₹3,500–5,000/person' },
      { name: 'Snorkelling at Elephant Beach', description: 'A 20-min boat ride from Havelock brings you to Elephant Beach — the best snorkelling reef in the Andamans. Coral, sea turtles, clownfish, and parrotfish in 2–5m depth.', image: 'https://images.unsplash.com/photo-1526481280693-3bfa7568e0f3?w=800&q=80', duration: '2–3 hours', cost: '₹1,500 boat + gear' },
    ],
    travelTips: [
