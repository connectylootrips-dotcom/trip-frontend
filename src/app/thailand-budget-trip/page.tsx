...
const pkg: PackageData = {
  ...
  overview: [
    ...
    'Our budget Thailand trip splits your time between Bangkok (2 nights — temples, markets, street food, rooftop bars) and Phuket (3 nights — white sand beaches, island-hopping, snorkeling, Thai boxing shows). Both are connected by a quick 1-hour domestic flight (booked separately, typically ₹2,000–₹4,000 with AirAsia).',
    'This is India\'s most booked international package for good reason: you get everything — hotels, transfers, guided city tour, Phi Phi island day trip, Thai cooking class, night market dinner, and more — for ₹49,499 per person. Thailand doesn\'t require a visa for Indians (30 days visa-free since 2024), and the baht is very favorable against the rupee.',
  ...
  highlights: [
    ...
    'Bangkok → Phuket domestic flight (not included — approx ₹2,000–4,000 on AirAsia)',
  ],
  ...
  itinerary: [
    ...
    { day: 3, title: 'Bangkok to Phuket — Beach Life Begins', description: 'Hotel breakfast and check-out. Transfer to Suvarnabhumi Airport for your domestic flight to Phuket (1 hour, Air Asia — booked separately). Arrive Phuket, pick up by hotel shuttle or private transfer to Patong or Kata Beach hotel. Afternoon: first beach day — clear Andaman Sea, sunbeds, banana boats, jet ski. Sunset drinks at a beachside bar. Evening: explore Bangla Road — Phuket\'s legendary entertainment street lined with bars, clubs, cabaret shows (Simon Cabaret), and street performances.', meals: 'Breakfast', hotel: '3★ Beach Hotel, Phuket', activities: ['Bangkok to Phuket domestic flight (self-arranged)', 'Beach arrival', 'Patong Beach afternoon', 'Bangla Road evening'] },
  ...
  excludes: [
    'International flights India ↔ Bangkok (book separately)',
    'Bangkok → Phuket domestic flight (book separately, approx ₹2,000–4,000)',
  ...
  faqs: [
    { question: 'What is the total cost of a Thailand trip from India in 2026?', answer: 'Our Thailand budget package starts at ₹49,499 per person (5 nights, Bangkok + Phuket). This includes hotels, breakfast, and all listed activities. International flights and the Bangkok–Phuket domestic flight are booked separately. Budget ₹18,000–₹30,000 extra per person for flights, meals, shopping, nightlife, and optional add-ons.' },
