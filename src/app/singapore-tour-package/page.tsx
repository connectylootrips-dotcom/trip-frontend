...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Singapore Tour Package from India — ₹44,999 Onwards',
...
const pkg: PackageData = {
  ...
  mustVisitPlaces: [
    { name: 'Gardens by the Bay — Supertree Grove', description: '18 tree-like vertical gardens standing 25–50m tall, with the Garden Rhapsody light-and-music show every night at 7:45pm and 8:45pm. The elevated OCBC Skyway connects the largest Supertrees.', image: 'https://images.unsplash.com/photo-1547201240-5d8be2f1ca5e?w=800&q=80', type: 'experience', tip: 'The Supertree Grove light show is free (ground level). The Skyway (₹800) and Domes need paid entry. Arrive at 6:30pm for sunset plus the 7:45pm show in one trip.' },
    { name: 'Marina Bay Sands SkyPark', description: 'The iconic 57th-floor infinity pool and observation deck spanning three towers above the Singapore skyline. The SkyPark observation deck is one of Asia\'s finest city panoramas.', image: 'https://images.unsplash.com/photo-1508964942454-1a56651d54ac?w=800&q=80', type: 'landmark', tip: 'Non-hotel guests pay SGD 23 for SkyPark Observation Deck access. Hotel guests use the famous infinity pool. Go at sunset (6pm) for the best city and bay views.' },
    { name: 'Chinatown & Hawker Centre Food Trail', description: 'Singapore\'s best street food is in its hawker centres — Maxwell Food Centre, Old Airport Road, and Tiong Bahru Market. Michelin-starred Hawker Chan and Liao Fan are both in Chinatown.', image: 'https://images.unsplash.com/photo-1565967511849-76a60a516170?w=800&q=80', type: 'food', tip: 'Dinner at Maxwell Food Centre — arrive at 6:30pm when all stalls are open. Tian Tian Chicken Rice (the stall, not the restaurant) and the curry fish head stall opposite are must-tries.' },
  ],
  packageActivities: [
    { name: 'Universal Studios Singapore', description: 'Hollywood-themed theme park with Transformers 3D, Jurassic World, Madagascar, and Minion Land. Singapore\'s version has several exclusive rides not available in Hollywood.', image: 'https://images.unsplash.com/photo-1582672060674-bc2bd808a8b5?w=800&q=80', duration: 'Full day', cost: 'Included in package' },
