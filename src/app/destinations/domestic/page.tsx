...
const INTL_TRIPS: DomesticTrip[] = [
  ...
  { slug: 'europe-tour-package-from-india', title: 'Europe Tour Package', location: 'Paris · Rome · Barcelona · Amsterdam · Prague', region: 'International', category: 'Sightseeing Tour', duration: '10 Nights / 11 Days', nights: 10, priceINR: 124999, originalPriceINR: 159999, image: 'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=800&q=80', badge: 'Dream Trip', highlights: ['Eiffel Tower & Louvre, Paris', 'Colosseum & Vatican, Rome', 'Sagrada Família, Barcelona', 'Charles Bridge, Prague'], includes: ['10 nights hotels', 'Inter-city trains', 'Schengen visa support', 'All transfers'], itinerary: [], packageHref: '/europe-tour-package-from-india' },
  { slug: 'japan-tour-package', title: 'Japan Tour Package', location: 'Tokyo · Kyoto · Osaka', region: 'International', category: 'Sightseeing Tour', duration: '7 Nights / 8 Days', nights: 7, priceINR: 172799, originalPriceINR: 219999, image: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?w=800&q=80', badge: 'Premium', highlights: ['Mt. Fuji & Hakone viewpoint', 'Fushimi Inari 10,000 torii gates', 'Shinkansen bullet train', 'Nara deer park & Todai-ji'], includes: ['7 nights hotels', 'Japan Rail Pass (7-day)', 'Tea ceremony Kyoto', 'All transfers'], itinerary: [], packageHref: '/japan-tour-package' },
  { slug: 'georgia-azerbaijan-tour-package', title: 'Georgia & Azerbaijan Tour', location: 'Tbilisi · Kazbegi · Baku', region: 'International', category: 'Adventure Tour', duration: '6 Nights / 7 Days', nights: 6, priceINR: 54999, originalPriceINR: 71999, image: 'https://images.unsplash.com/photo-1565008576549-57569a49371d?w=800&q=80', badge: 'Hidden Gem', highlights: ['Old Tbilisi sulphur baths', 'Kazbegi & Gergeti Trinity Church', 'Baku Flame Towers', 'Mtskheta UNESCO site'], includes: ['6 nights hotels', 'Kazbegi 4x4 day trip', 'Tbilisi → Baku transfer', 'All transfers'], itinerary: [], packageHref: '/georgia-azerbaijan-tour-package' },
  { slug: 'kenya-safari-package', title: 'Kenya Safari Package', location: 'Nairobi · Masai Mara · Amboseli · Diani Beach', region: 'International', category: 'Adventure Tour', duration: '7 Nights / 8 Days', nights: 7, priceINR: 224999, originalPriceINR: 289999, image: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800&q=80', badge: 'Bucket List', highlights: ['Masai Mara game drives & Great Migration', 'Amboseli with Mt. Kilimanjaro backdrop', 'Big Five wildlife safari', 'Diani Beach Indian Ocean'], includes: ['7 nights (tented camp + lodge + resort)', 'All meals at safari camps', 'Game drives with Masai guide', 'All inter-park transfers'], itinerary: [], packageHref: '/kenya-safari-package' },
];
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1ebe5d] text-white px-8 py-4 font-semibold text-sm uppercase tracking-widest transition-colors rounded-sm w-full sm:w-auto"
              >
                <MessageCircle className="w-5 h-5" />
                {isInternational ? 'WhatsApp Our India Experts' : 'Chat on WhatsApp'}
              </a>
              <Link href="/contact" className="flex items-center justify-center gap-2 border border-cream/25 text-cream hover:border-cream hover:bg-white/5 px-8 py-4 text-sm uppercase tracking-widest transition-all rounded-sm w-full sm:w-auto">
