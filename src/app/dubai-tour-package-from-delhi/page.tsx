...
const pkg: PackageData = {
  ...
  overview: [
    ...
    'Our 5-night Dubai package from Delhi covers everything you need for a truly memorable holiday: a centrally located 4-star hotel, the iconic Burj Khalifa At The Top experience, an exhilarating desert safari with barbecue dinner, a guided city tour covering Old Dubai and the Dubai Creek, a full day at Dubai Parks, and plenty of time for world-class shopping at Dubai Mall and Mall of the Emirates.',
  ...
  itinerary: [
    { day: 1, title: 'Arrive Dubai — Check In & First Evening', description: 'Arrive at Dubai International Airport on your flight from Delhi (approx. 3h 15m — book separately). Our driver will be waiting in the arrivals hall with your name board. Transfer to your 4-star hotel in Deira or Bur Dubai. Check-in, freshen up, and head out for a relaxed first evening at Dubai Creek — take an Abra (traditional water taxi) across the creek for ₹150 and explore the Gold Souk and Spice Souk at your own pace. Welcome dinner at a rooftop restaurant is optional but highly recommended.', meals: 'None', hotel: '4★ Hotel in Deira / Bur Dubai', activities: ['Airport pickup', 'Hotel check-in', 'Dubai Creek Abra ride', 'Gold Souk & Spice Souk stroll'] },
  ...
  excludes: [
    'International flights Delhi ↔ Dubai (book separately)',
  ...
  faqs: [
    { question: 'How much does a Dubai trip from Delhi actually cost in 2026?', answer: 'Our Dubai package from Delhi starts at ₹36,499 per person for 5 nights. This includes visa, 4-star hotel with breakfast, Burj Khalifa, desert safari, and airport transfers. International flights are booked separately. Budget ₹20,000–₹30,000 extra per person for flights, meals, shopping, and optional activities like Ski Dubai or dhow cruise.' },
  ...
  mustVisitPlaces: [
    { name: 'Burj Khalifa — Top of the World', description: 'The world\'s tallest building at 828m. The 124th floor observation deck gives an astonishing 360° view of Dubai\'s coastline, desert, and the city grid below. The 148th floor (Top Sky) goes even higher.', image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&q=80', type: 'landmark', tip: 'Book sunset slot (tickets.burjkhalifa.ae) 2–3 weeks ahead. The Dubai Fountain show below starts at 6pm and is best seen from the 124F terrace.' },
    { name: 'Dubai Desert Safari', description: 'Dune bashing in a 4×4 across the red Hatta desert, camel rides, sandboarding, henna art, and a Bedouin camp BBQ dinner with belly dancing and tanoura whirling under the stars.', image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&q=80', type: 'experience', tip: 'Choose the private 4×4 option over group safari — the dune bashing is far more thrilling with a dedicated vehicle. Evening starts at 3pm return by 10pm.' },
    { name: 'Palm Jumeirah & Atlantis', description: 'The man-made palm-shaped island — the Monorail from Al Ghubaiba station gives aerial views of the palm fronds. Atlantis Aquaventure (water park) and the underwater Aquatrek are Dubai\'s best family experiences.', image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&q=80', type: 'landmark', tip: 'The Palm Jumeirah monorail (₹300 return) is the best way to see the palm from above without paying for a helicopter. Includes a stop at the Atlantis Beach.' },
  ],
  packageActivities: [
    { name: 'Dubai Frame — Skybridge Walk', description: 'A 150m picture frame between old and new Dubai — the skybridge glass floor above the city and the museum inside that contrasts old Dubai with the modern skyline is one of the city\'s best experiences.', image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&q=80', duration: '1.5 hours', cost: 'Included in package' },
    { name: 'Dubai Creek & Gold Souq', description: 'Take an Abra (wooden water taxi) across the historic creek to the Gold Souq — 300 gold shops with 25 tonnes of gold on display in a 1-kilometre gold-glittering alley. The Spice Souq adjacent smells of saffron and cardamom.', image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&q=80', duration: '2 hours', cost: '₹5 abra + shopping' },
  ],
  travelTips: [
    'Dubai is very efficient — visa-on-arrival for Indians (30 days, free as of 2024). Confirm current visa policy before travel at GDRFA Dubai.',
    'Dress modestly in malls and public areas — shoulders and knees covered. Swimwear only on beach or pool areas. Avoid public affection.',
    'Ramadan in Dubai: restaurants are closed during daytime fasting hours. Evening iftar is spectacular — book the Ramadan tent experience at any 5-star hotel.',
    'The Dubai Metro (Red Line) covers all major tourist sites. Day pass ₹500. Much cheaper than taxis for Burj Khalifa, Mall of Emirates, and Palm.',
  ],
};
