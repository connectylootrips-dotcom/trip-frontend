          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-4 space-y-5">
              ...
              <div className="border border-white/20 rounded px-4 py-3 space-y-1">
                ...
                <p className="text-[10px] text-white/80 font-semibold">Ambe Enterprise</p>
                <p className="text-[10px] text-white/60">(Trading as YlooTrips)</p>
                ...
                >
                  ...
                  <span className="text-[10px] text-white/70 hover:text-white transition-colors">4.9★ Google Reviews</span>
                </a>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <div className="text-left">
                    <p className="text-[9px] text-white/60 leading-none uppercase tracking-wider">Now on Google Play</p>
                    <p className="text-sm font-semibold text-white leading-tight">Download Free App</p>
                  </div>
                  <span className="ml-1 text-[9px] font-bold uppercase tracking-wider bg-green-500/80 text-white px-1.5 py-0.5 rounded">New</span>
                </a>
                <p className="text-[9px] text-white/40 mt-1.5">Launched August 2026</p>
              </div>
        ...
        <div className="border-t border-white/20">
          ...
          <div className="section-container pt-5 pb-2">
            <div className="flex items-center justify-center gap-8">
              ...
              <a href="https://www.youtube.com/@Ylootrips-com" target="_blank" rel="noopener noreferrer"
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-3 text-center sm:text-left">
              <div className="space-y-1">
                <p className="text-[10px] text-white/70 uppercase tracking-widest">
                  © {currentYear} Ambe Enterprise (YlooTrips) · All rights reserved.
                </p>
